...
class MainPageState extends State<MainPage> with SingleTickerProviderStateMixin {
  ...
  void initState(){
    ...
    /*_bottomBarNavigation = new NavigationBar(_tabController);
            ...
            new Container(
              ...
              child: new Column(
                ...
                children: <Widget>[
                  ...
                  new IconButton(Icons.event_note, 'News', () {_changeTo(new ClassroomBody());}, Colors.black54, Colors.black54),

                  new IconButton(Icons.schedule, 'Courses', () {_changeToCourses();}, Colors.black54, Colors.black54),

                  new IconButton(Icons.assignment, 'My Courses', () {_changeToMyCourses();}, Colors.black54, Colors.black54),
                  
                  new IconButton(Icons.business, 'Classrooms', () {_changeTo(new ClassroomBody());}, Colors.black54, Colors.black54),

                  new IconButton(Icons.group, 'Teachers', () {print('Teachers');}, Colors.black54, Colors.black54),

                  new Padding(padding: new EdgeInsets.only(top: 24.0)),

                  new IconButton(Icons.account_box, 'Acount', () {print("Acount");},  Colors.black54, Colors.black54),

                  new IconButton(Icons.block, 'Logout', () {print('Logout');},  Colors.black54, Colors.black54)
                ],
              ),
            )
          ],
...
class NavigationBar extends StatelessWidget {
  ...
  NavigationBar(this._controller);
...
class IconButton extends StatelessWidget{
  ...
  IconButton(this._icon, this._text, this._method, this._textColor, this._iconColor);
    ...
    return new FlatButton(
        child: new Row(
            children: <Widget>[
              ...
              new Text(_text, style: new TextStyle(fontSize: 16.0, color: _textColor)),
            ]
        ),
        onPressed: _method
    );
...
class UserDetailsState extends State<UserDetails> {
  ...
  getFromSharedPrefs() async {
    ...
    setState((){
      ...
      _studentClass = 'Class ' + sharedPreferences.getInt(Constants.studentClass).toString();
    });
  }
